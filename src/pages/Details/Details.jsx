...
import { FaClock, FaCommentAlt,  FaEnvelope,  FaShare,  FaThumbsDown, FaThumbsUp } from 'react-icons/fa';
            ...
            <div className="container px-4 md:px-0">
                <div className='grid lg:grid-cols-3  gap-5'>
                    <div className='col-span-2 grid grid-cols-1 gap-7'>
                                ...
                                <div  className="flex gap-5 p-5">
                                    {
                                        ...
                                        <span className='w-20 h-20 inline-block'>
                                            <img className='w-16 h-16 rounded-full mx-auto' src={ user?.photoURL ? user?.photoURL : "https://cdn.pixabay.com/photo/2016/11/18/23/38/child-1837375_640.png"} alt="" />
                                            <p className="text-center mt-2 text-gray-500">{authorName}</p>
                                        </span>
                                    </div>
                                    }
                                    <div className="w-full bg-gray-100 p-3">
                                        ...
                                        <textarea name="comment" required className="w-full block outline-none mt-1 bg-gray-100 " id="" cols="30" rows="3"></textarea>
                                    </div>
                                </div>
                                <hr />
                        ...
                        {
                            comments &&  <p className="text-lg font-medium mt-8">Comments</p>
                        }
                       

                        { comments &&
                            comments?.map(comment =>    <div key={comment?._id} className='border shadow-sm bg-white'>
                            <div className='flex gap-5 py-5 px-5'>
                               
                                <div className="w-full">
                                  
                                    <p className='text-[15px] leading-6 text-gray-500 font-normal'>{comment?.comment}</p>
                                </div>
                            </div>
                            <hr />
                            <div className='py-1'>
                                <div className='flex px-5 gap-6'>
                                    ...
                                    <div className='flex items-center justify-between gap-4 w-full'>
                                        <div className='flex items-center gap-4'>
                                            ...
                                            <span className='flex gap-1 items-center text-gray-400'><FaEnvelope /><span className='text-xs text-gray-500'>{comment?.userEmail}</span></span>
