                        ...
                        <div className="flex mt-4 md:mt-6">
                            {
                                ...
                                <button className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200   ms-3">Bronze</button>
                                :
                                <button className="inline-flex items-center px-4 py-2 text-sm font-medium text-center  bg-yellow-50 rounded-lg  focus:ring-4 focus:outline-none focus:ring-yellow-400 ">Gold</button>
                            }
